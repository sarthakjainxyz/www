...
export default function Home() {
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-6 pb-20 gap-12 sm:p-20 font-[family-name:var(--font-geist-mono)] max-w-full overflow-x-hidden">
      <main className="flex flex-col gap-8 row-start-2 items-center text-center">
        <h1 className="font-bold text-4xl sm:text-5xl whitespace-nowrap">Sarthak Jain</h1>
